...
let playstate = "no";
let currentSong = 1;
let music = new Audio("music/song1.mp3");
...
function process(rawText) {
  ...
  if (text.includes("+")) {
    ...
    //handleSubmit("Apple Corporation");
    //console.log(response);
  }

  function playMusic() {
    if (currentSong == 1) {
      music = new Audio("music/song1.mp3");
      startin(3);

      response = "Playing  study beats 1";
      music.play();
    } else if (currentSong == 2) {
      music = new Audio("music/song2.mp3");
      startin(3);

      response = "Playing  study beats 2";
      music.play();
    } else if (currentSong == 3) {
      music = new Audio("music/song3.mp3");
      startin(3);

      response = "Playing  study beats 3";
      music.play();
    } else if (currentSong == 4) {
      music = new Audio("music/song4.mp3");
      startin(3);
      response = "Playing  study beats 4";
      music.play();
    }
  }
  ...
  /*if (text.includes("stop") || text.includes("bye")) {
    response = "Goodbye!";
    toggleBtn();
  }*/
